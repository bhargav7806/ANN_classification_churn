...
with open('label_enoder_gender_reg.pkl' , 'rb') as file:
    label_encoder_gender = pickle.load(file)
with open('oht_enoder_geo.pkl' ,'rb') as file:
...
geography = st.selectbox('Geography' , oht_encoder_geo.categories_[0])
...
geo_encoded = oht_encoder_geo.transform([[geography]]).toarray()
